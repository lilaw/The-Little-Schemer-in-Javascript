...
export { add1, car, cdr, cons, isAtom, isBoolean, isEq, isFunction, isList, isNumber, isNull, isUndefined, isZero, sub1}
...
//                 ? neo
//                 : car(l)
//             : insertRstar(neo, old, car(l)), subststar(neo, old, cdr(l)));
// }
...
//     insertR = insertG(sisEqR),
//     subst   = insertG(sisEqS),
//     rember  = insertG(sisEqrem);
...
//             : isEq(car(lat), oldR)
//                 ? cons(oldR, cons(neo, multiinsertLR(neo, oldL, oldR, cdr(lat))))
...
//                     }
//                 )
//                 : multiinsertLRCO(neo, oldL, oldR, cdr(lat), function (newlat, L, R) {
...
//     return isElse(questionOf(car(lines)))
...
//     var c = oldContext ? Object.create(oldContext) : {}, i;
